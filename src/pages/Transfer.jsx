...
import { ArrowDown, DollarSign, CreditCard, Send as SendIcon } from 'lucide-react';
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
                ...
                <div className="glass-panel" style={{ padding: '32px' }}>
                    <form onSubmit={handleTransfer} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        ...
                        {/* Amount Input */}
                        <div>
                            <label style={{ display: 'block', marginBottom: '12px', fontSize: '0.9rem', color: 'var(--text-muted)' }}>Amount to send (JPY)</label>
                        ...
                        {/* Recipient Details */}
                        <h3 style={{ fontSize: '1.1rem', marginTop: '16px', borderBottom: '1px solid var(--glass-border)', paddingBottom: '12px' }}>Recipient Details</h3>

                        <div style={{ display: 'grid', gap: '16px' }}>
                            <div>
                                <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.8rem', color: 'var(--text-muted)' }}>Bank Name</label>
                            ...
                            <div>
                                <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.8rem', color: 'var(--text-muted)' }}>Account Number</label>
                                <input type="text" className="input-field" placeholder="1234567890" required />
                            </div>

                            <div>
                                <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.8rem', color: 'var(--text-muted)' }}>Recipient Name</label>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div className="glass-panel" style={{ padding: '24px', background: 'linear-gradient(135deg, rgba(236, 72, 153, 0.2), rgba(99, 102, 241, 0.2))' }}>
                        ...
                        <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                            You will earn <span style={{ color: 'white', fontWeight: 'bold' }}>50 points</span> for this transaction!
                        </p>
                    </div>
                </div>
            </div>
